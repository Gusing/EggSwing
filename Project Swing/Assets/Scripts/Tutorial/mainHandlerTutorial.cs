...
public class mainHandlerTutorial : MonoBehaviour {
    ...
    int tutorialState;
    float tutorialTimer;
    //public Text txtTutorial1;
    public TextMeshProUGUI txtTutorial1;
    //public Text txtTutorial2;
    public TextMeshProUGUI txtTutorial2;
    ...
    void UpdateTutorial()
    {
        ...
        if (tutorialState == 0 && tutorialTimer >= 3)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Here you must fight to the beat!";
        }
        ...
        if (tutorialState == 1 && tutorialTimer >= 5 && currentState == BEAT)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Look at the indicator below";
        ...
        if (tutorialState == 6)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Nice grooving!";
        ...
        if (tutorialState == 14)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Fantastic defense!";
            txtTutorial2.text = "";
            soundMusic.setParameterValue("Tutorial", 0);
            imgLineMarker.enabled = false;
            imgLineSignal.enabled = false;
        ...
        if (tutorialState == 19)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Now Finish it!";
            txtTutorial2.text = "";
        ...
        if (tutorialState == 21)
        {
            tutorialState++;
            tutorialTimer = 0;
            txtTutorial1.text = "Now go, make the battlefield your dance floor!";
            soundMusic.setParameterValue("Tutorial", 0);
